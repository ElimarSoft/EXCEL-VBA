...
Private Sub RawToTable(newCols As Integer, transpose As Boolean)
    ...
    'This function converts a raw colum of data to a table of the specified colums
    'Select the data and excute the function
    'The table will appear at next column
